...
6. **Authentication:** by default DO selects "One-time password" if you have no ssh key added. I'll be using ssh to login to my DO droplet, I'll advise you do the same. If you don't know anything about ssh keys, kindly refer to a previous [post](https://jherey.netlify.com/posts/intro-to-ssh/) of mine. Copy your ssh key and click on _"New SSH key"_.
